...
import (
	...
	selector "github.com/pingcap/dm/tidb-tools/pkg/table-rule-selector"
...
func setNull(info *mappingInfo, vals []interface{}) ([]interface{}, error) {
	vals[info.targetPosition] = "NULL"
	return vals, nil
}
