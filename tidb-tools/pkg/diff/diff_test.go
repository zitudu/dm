...
import (
	...
	"github.com/pingcap/dm/tidb-tools/pkg/importer"
...
func testDataEqual(ctx context.Context, conn *sql.DB, schema string, sourceTables []string, targetTable string, hasEmptyTable bool, c *C) {
	...
	c.Assert(failpoint.Enable("github.com/pingcap/dm/tidb-tools/pkg/diff/CancelCheckChunkDataEqual", `return(2)`), IsNil)
	defer failpoint.Disable("github.com/pingcap/dm/tidb-tools/pkg/diff/CancelCheckChunkDataEqual")
